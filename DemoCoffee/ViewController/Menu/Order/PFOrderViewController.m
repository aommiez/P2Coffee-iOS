...
- (void)viewDidLoad
{
    ...
    NSString *url = [[NSString alloc] initWithFormat:@"%@%@%@%@%@%@",@"http://apps.pla2.com/webview/preorder/page2.php?product_id=",self.product_id,@"&user=",self.user_id,@"&domain=coffee&token=",self.token];
