...
- (void)loginViewFetchedUserInfo:(FBLoginView *)loginView
    ...
    if ([devicetoken isEqualToString:@""]) {
        [self.Demoapi loginWithFacebookToken:fbAccessToken ios_device_token:@""];
    } else {
        [self.Demoapi loginWithFacebookToken:fbAccessToken ios_device_token:[defaults objectForKey:@"deviceToken"]];
    }
